...
You can use the Intent CLI to bootstrap your project, which will bring in the required artifacts in your environment. Run:
...
intent init <project_name> --ai gemini
intent init <project_name> --ai copilot

# Or in current directory:
intent init . --ai claude
intent init . --ai codex
...
Once ready, use the `/intent.implement` command to execute your implementation plan:
